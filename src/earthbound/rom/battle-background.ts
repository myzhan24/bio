...
export class BattleBackground {
  ...
  */
  ...
  /**
   * Determines the animation speed of the palette cycle in frames the animation is held.
   * (ie. 3 = palette changes every 3 frames, 60 = palette changes every 60 frames)
   */
